...
latex_documents = [
  (master_doc, 'mozrepl.tex', u'mozrepl Documentation',
   u'별님', 'manual'),
]
...
man_pages = [
    (master_doc, 'mozrepl', u'mozrepl Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'mozrepl', u'mozrepl Documentation',
   author, 'mozrepl', 'One line description of project.',
   'Miscellaneous'),
]
